...
class bitmex (Exchange):
    ...
    def get_symbol_to_unified_symbol_dict(self, markets):
        char_to_month_number = {"F": 1, "G": 2, "H": 3, "J": 4, "K": 5, "M": 6, "N": 7, "Q": 8, "U": 9,
                                "V": 10, "X": 11, "Z": 12}
        ...
        for market in markets:
            ...
            if market.get("expiry"):
                expiration = datetime.strptime(market["expiry"], '%Y-%m-%dT%H:%M:%S.%fZ')
            ...
            base, quote = self.common_currency_code(base), self.common_currency_code(quote)
            symbol = base + "/" + quote
