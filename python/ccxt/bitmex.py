...
class bitmex (Exchange):
    ...
    def parse_order(self, order, market=None):
        ...
        last_trade_timestamp = self.parse8601(self.safe_string(order, 'transactTime'))
        price = self.safe_float(order, 'price')
        ...
        if filled is not None:
            ...
            _action = (lambda x: x[0] / x[1]) if pair == currency else (lambda x: x[0] * x[1])
            _price = average or price
            if _price:
                cost = _action((filled, _price))
