                ...
                'contract': {
                    'public': {
                        'get': [
                            'ping',
                            'detail',
                            'support_currencies',  # TODO: should we implement 'fetchCurrencies' solely for swap? because spot doesnt have it atm
                            'depth/{symbol}',
                    ...
                    'private': {
                        'get': [
                            ...
                            'account/risk_limit',  # TO_DO: gets max/min position size, allowed sides, leverage, maintenance margin, initial margin, etc...
                            'account/tiered_fee_rate',  # TO_DO: taker/maker fees for account
                            'position/leverage',
                        ],
                        'post': [
                            'position/change_margin',
                            'position/change_leverage',
                            'position/change_position_mode',
                            'order/submit',
                            'order/submit_batch',
                            'order/cancel',
                ...
                'spot2': {
                    ...
                    'private': {
                        'get': [
                            ...
                            'asset/address/list',
                            'asset/withdraw/list',
                            'asset/internal/transfer/record',
                            'account/balance',
                            'asset/internal/transfer/info',
                            'market/api_symbols',
                        ],
                        'post': [
                            'order/place',
                            'order/place_batch',
                            'order/advanced/place_batch',
                            'asset/withdraw',
