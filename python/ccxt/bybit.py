...
class bybit(Exchange):
            ...
            'api': {
                'public': {
                    'get': [
                        ...
                        'derivatives/v3/public/insurance',
                        # v5
                ...
                'private': {
                    'get': [
                        ...
                        'v2/public/risk-limit/list',  # TODO check
                        'v2/public/funding/prev-funding-rate',  # TODO check
                        'v2/private/funding/prev-funding',
                        'v2/private/funding/predicted-funding',
                        'v2/private/account/api-key',
                        'v2/private/account/lcp',
                        'v2/private/wallet/balance',  # 120 per minute = 2 per second => cost = 50 / 2 = 25
                        ...
                        'spot/v1/myTrades',
                        'spot/v1/cross-margin/order',
                        'spot/v1/cross-margin/accounts/balance',
                        'spot/v1/cross-margin/loan-info',
                        'spot/v1/cross-margin/repay/history',
                        ...
                        # account
                        'asset/v1/private/transfer/list',  # 60 per minute = 1 per second => cost = 50 / 1 = 50
                        'asset/v3/private/transfer/inter-transfer/list/query',  # 60/s
                        'asset/v1/private/sub-member/transfer/list',
                        'asset/v3/private/transfer/sub-member/list/query',  # 60/s
                        'asset/v3/private/transfer/sub-member-transfer/list/query',  # 60/s
                        'asset/v3/private/transfer/universal-transfer/list/query',  # 60/s
                        ...
                        'asset/v3/private/coin-info/query',  # 2/s
                        'asset/v1/private/asset-info/query',
                        'asset/v1/private/deposit/address',
                        'asset/v3/private/deposit/address/query',  # 300/s
                        ...
                        'contract/v3/private/position/limit-info',  # 120 per minute = 2 per second => cost = 50 / 2 = 25
                        ...
                        'unified/v3/private/account/info',
                        'user/v3/private/frozen-sub-member',  # 5/s
                        'user/v3/private/query-sub-members',  # 10/s
                        'user/v3/private/query-api',  # 10/s
                        'user/v3/private/get-member-type',
                        'asset/v3/private/transfer/transfer-coin/list/query',  # 60/s
                        'asset/v3/private/transfer/account-coin/balance/query',  # 60/s
                        'asset/v3/private/transfer/account-coins/balance/query',
                        'asset/v3/private/transfer/asset-info/query',  # 60/s
                        'asset/v3/public/deposit/allowed-deposit-list/query',  # 300/s
                        'asset/v3/private/deposit/record/query',  # 300/s
                        'asset/v3/private/withdraw/record/query',  # 300/s
                        # v5
                        # trade
                    ...
                    'post': [
                        ...
                        'v2/private/order/cancelAll',  # 100 per minute + 'consumes 10 requests'
                        ...
                        'private/linear/position/set-leverage',  # 75 per minute = 1.25 per second => cost = 50 / 1.25 = 40
                        ...
                        # account
                        'asset/v1/private/transfer',  # 20 per minute = 0.333 per second => cost = 50 / 0.3333 = 150
                        'asset/v3/private/transfer/inter-transfer',  # 20/s
                        'asset/v1/private/sub-member/transfer',
                        'asset/v1/private/withdraw',
                        'asset/v3/private/withdraw/create',  # 10/s
                        'asset/v1/private/withdraw/cancel',
                        'asset/v3/private/withdraw/cancel',  # 60/s
                        'asset/v1/private/transferable-subs/save',
                        'asset/v1/private/universal/transfer',
                        'asset/v3/private/transfer/sub-member-transfer',  # 20/s
                        'asset/v3/private/transfer/transfer-sub-member-save',  # 20/s
                        'asset/v3/private/transfer/universal-transfer',  # 20/s
                        'user/v3/private/create-sub-member',  # 5/s
                        'user/v3/private/create-sub-api',  # 5/s
                        'user/v3/private/update-api',  # 5/s
                        'user/v3/private/delete-api',  # 5/s
                        'user/v3/private/update-sub-api',  # 5/s
                        'user/v3/private/delete-sub-api',  # 5/s
                        # USDC endpoints
                        # option USDC
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount, price=None, params={}):
        ...
        elif enableUnifiedMargin and not self.is_inverse():
            raise NotSupported()
        elif isUSDCSettled:
    ...
    def create_unified_account_order(self, symbol: str, type, side, amount, price=None, params={}):
        ...
        request = {
            ...
            'category': self.get_category(support_inverse=False)
    ...
    def edit_unified_account_order(self, id: str, symbol, type, side, amount=None, price=None, params={}):
        self.load_markets()
        market = self.market(symbol)
        if not self.is_linear() and not market['option']:
    ...
    def cancel_unified_account_order(self, id: str, symbol: Optional[str] = None, params={}):
        ...
        if id is not None:  # The user can also use argument params["orderLinkId"]
            request['orderId'] = id
        request['category'] = self.get_category(support_inverse=False)
    ...
    def cancel_all_unified_account_orders(self, symbol: Optional[str] = None, params={}):
        ...
        if self.is_spot():
            ...
            raise NotSupported(self.id + ' cancelAllOrders() does not allow inverse market orders')
    ...
    def fetch_unified_account_open_orders(self, symbol: Optional[str] = None, since: Optional[int] = None, limit: Optional[int] = None, params={}):
        ...
        market = None
        if symbol is None:
            request['category'] = self.get_category()  # TODO: check
        else:
            market = self.market(symbol)
            request['symbol'] = market['id']
            request['category'] = self.get_category(support_inverse=False)
    ...
    def fetch_my_unified_trades(self, symbol: Optional[str] = None, since: Optional[int] = None, limit: Optional[int] = None, params={}):
        ...
        if type == 'spot':
            ...
            if self.inverse():
                raise NotSupported(self.id + ' fetchMyTrades() does not support inverse markets.')
            request['category'] = self.get_category()
        if since is not None:
            request['startTime'] = since
        if limit is not None:
    ...
    def fetch_unified_positions(self, symbols: Optional[List[str]] = None, params={}):
        ...
        #     }
        #
        positions = self.add_pagination_cursor_to_result(response) # TODO:
        results = []
    ...
    def get_positions(self, symbol: str = None, symbols: Optional[List[str]] = None, params={}):
        return self.fetch_positions(symbols=symbols or [symbol], params=params)
    ...
    def set_margin_mode(self, marginMode, symbol: Optional[str] = None, params={}):
        ...
        if isUnifiedAccount:
            return self.set_unified_margin_mode(marginMode, params)
    ...
    def _change_margin_type(self, symbol, _id, is_cross, long_leverage, short_leverage):
        values = self.is_unified_enabled()
        isUnifiedAccount = self.safe_value(values, 1)
        if isUnifiedAccount:
            ...
            params = {'buy_leverage': long_leverage, 'sell_leverage': short_leverage}
    ...
    def classify_change_margin(self, symbol, _id, is_long, is_cross, leverage):
        ...
        if is_cross == _is_cross and (leverage == _leverage):
            ...
            return self._change_margin_type(symbol, _id, is_cross, long_leverage, short_leverage)
        else:
    ...
    def fetch_open_interest_history(self, symbol: str, timeframe='1h', since: Optional[int] = None, limit: Optional[int] = None, params={}):
        ...
        self.load_markets()
        market = self.market(symbol)
        if self.is_spot() or market['option']:
    ...
    def _get_best_risk_id(risk_limits, desired_limit):
        sorted_limits = sorted(risk_limits, key=lambda x: x["riskLimitValue"])
        for risk_limit in sorted_limits:
            if desired_limit <= risk_limit["riskLimitValue"]:
    ...
    def set_risk_limit(self, symbol, is_long=None, limit=None, risk_id=None):
        ...
        if risk_id is None:
            risk_limits = self.get_raw_risk_limits(symbol=symbol)
    ...
    def fetch_derivatives_market_leverage_tiers(self, symbol: str=None, params={}):
        tiers = self.get_raw_risk_limits(symbol=symbol)
        results = []
        for tier in tiers:
            symbol = self.safe_string(tier, 'symbol')
            market = self.markets_by_id[symbol]
            res = self.parse_market_leverage_tiers(tiers, market)
            results.append(res)
        return results
